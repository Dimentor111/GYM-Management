...
CREATE TABLE IF NOT EXISTS sale_items(id INTEGER PRIMARY KEY AUTOINCREMENT,sale_id INTEGER,product_id INTEGER,product_name TEXT,category TEXT,qty INTEGER,unit_price REAL,total REAL,item_type TEXT,ref_id INTEGER,status TEXT DEFAULT 'active',deleted_at TEXT,deleted_by TEXT,delete_reason TEXT,returned_to_stock INTEGER DEFAULT 0);
